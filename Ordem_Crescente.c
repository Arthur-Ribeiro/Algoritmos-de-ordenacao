...
void main()
{
    ...
    elapsed = stop - start;
    printf("\n\n\nTempo total bublleSort em segundos: %f\n\n\n", elapsed);
    ...
    printf("\n\n\nTempo total quickSort em segundos: %f\n\n\n", elapsed);
    ...
    printf("\n\n\nTempo total selectionSort em segundos: %f\n\n\n", elapsed);
    ...
    printf("\n\n\nTempo total insertionSort em segundos: %f\n\n\n", elapsed);
    ...
    printf("\n\n\nTempo total mergeSort em segundos: %f\n\n\n", elapsed);
    ...
    printf("\n\n\nTempo total hepsort em segundos: %f\n\n\n", elapsed);
}
